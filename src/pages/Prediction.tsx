...
import { BarChart3, PieChart, TrendingUp, MapPin, ArrowLeft } from "lucide-react";
        ...
        <div className="min-h-screen bg-background">
            ...
            <header className="bg-gradient-eco text-white py-6 shadow-lg">
                <div className="container mx-auto px-4">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold">Daily Waste Prediction</h1>
                    <p className="text-white/90 mt-2">การทำนายปริมาณขยะรายวัน - Daily Waste Prediction</p>
                </div>
            </header>
            ...
            <section className="py-16 md:py-24">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Waste Prediction</h2>
                        <p className="text-lg text-muted-foreground">การทำนายปริมาณขยะรายวัน</p>
                    </div>
